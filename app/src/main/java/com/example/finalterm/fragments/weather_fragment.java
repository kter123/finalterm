package com.example.finalterm.fragments;
...
import com.example.finalterm.weather.News;
import com.example.finalterm.weather.RequestNewsData;
...
public class weather_fragment extends Fragment {
    ...
    private static final String TAG = weather_fragment.class.getName();
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_weather_fragment, null);
